...
<header id="masthead" class="site-header">
	<div class="king-header header-11-left">
		...
		<div class="king-scroll header-11-menu">
			...
			<a href="#" class="header-11-item" data-toggle="dropdown" data-target="#sbox, .header-11-left" aria-expanded="false" role="button"><i class="fa fa-search" aria-hidden="true"></i><?php echo esc_html_e( 'Search', 'king' ); ?></a>
			...
			<a href="#" class="header-11-item" data-toggle="dropdown" data-target="#humenu, .header-11-left" aria-expanded="false" role="button">
				...
				<?php echo esc_html_e( 'Profile', 'king' ); ?></a>
		...
		<?php if ( get_field( 'disable_users_submit', 'options' ) !== true ) : ?>
			<?php if ( get_option( 'permalink_structure' ) ) : ?>
				<a href="#" class="header-11-item" data-toggle="modal" data-target="#submitmodal" role="button"><i class="fa fa-plus" aria-hidden="true"></i><?php echo esc_html_e( 'Create', 'king' ); ?></a>
			<?php endif; ?>
		<?php endif; ?>	
	</div>
