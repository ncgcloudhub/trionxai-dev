...
<?php if ( has_post_thumbnail() ) :
	...
	<div class="single-post-back king-box-bg" data-king-img-src="<?php echo esc_url( $thumb['0'] ); ?>"></div>
		<?php elseif ( get_field( 'default_background', 'option' ) ) : $dbackground = get_field( 'default_background', 'options' ); ?>
			<div class="single-post-back king-box-bg" data-king-img-src="<?php echo esc_url( $dbackground ); ?>"></div>
		<?php else : ?>
			<div class="single-post-back-no"></div>
		<?php endif; ?> 
		<div id="primary" class="content-area sing-template-4">
							...
							<?php if ( have_rows( 'news_list_items' ) ) : ?>
								...
								<div class="king-lists">
									...
									<?php while ( have_rows( 'news_list_items' ) ) : the_row();
										...
										$ftitle  = get_sub_field( 'news_list_title' );
										$content = get_sub_field( 'news_list_content' );
										?>
										<div class="list-item">

											<span class="list-item-title"><span class="list-item-number">#<?php echo esc_html( $i ); ?></span><h3><?php echo esc_html( $ftitle ); ?></h3></span>
											<?php if ( $image ) : ?>
