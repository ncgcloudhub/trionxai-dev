			...
			<div class="king-affi-link">
				<?php if ( get_field( 'enable_affiliate' ) && get_field( 'sale_price' ) ) : ?>
					<span class="affi-price">
						<i class="fa-solid fa-tags"></i> <s><?php echo ( !empty(get_field( 'regular_price' )) ? esc_html_e( '$', 'king' ) . get_field( 'regular_price' ) : '' ); ?></s> <b><?php echo esc_html_e( '$', 'king' ); ?><?php the_field( 'sale_price' ); ?></b>
					</span>
