...
$course_title       = esc_textarea(ucwords(strtolower($course->post_title)));
    ...
    <div class="container">
      <div class="vertical-center">
        ...
        <p class="completion-date">
          <?php if ($course->certificates_completion_date == 'enabled') { ?><span><b><?php esc_html_e('COMPLETED', 'memberpress-courses'); ?>:</b> <?php echo esc_html(wp_date('F jS Y', strtotime($last_completion_date))); ?></span><?php } ?>
          <?php if ($course->certificates_expiration_date == 'enabled') { ?><span><b><?php esc_html_e('EXPIRES', 'memberpress-courses'); ?>:</b> <?php echo esc_html(wp_date('F jS Y', $last_completion_datetime->getTimestamp())); ?></span><?php } ?>
        </p>
        <?php } ?>
