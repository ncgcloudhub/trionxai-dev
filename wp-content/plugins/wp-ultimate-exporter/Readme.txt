...
Tags: export, migration, csv, elementor export, woocommerce, orders, product export, csv export, order export, users export, woocommerce, orders, refunds, customers, export data, export, wordpress export
...
The plugin supports to export file formats like CSV or XML. The advanced filter options will ease up the whole process. It helps to export only the data required without many complications. Also, filters for author, delimiters, status, and time range are available.
...
* [Pro plugin demo site](https://demo.smackcoders.com/wordpress/wp-admin/admin.php?page=sm-uci-dashboard&utm_source=WpOrg&utm_medium=Readme&utm_campaign=free_exporter).
...
= 2.4.1 =
* Upgrade now to get security patch.
