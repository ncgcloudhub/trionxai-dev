...
if ( ! current_user_can('manage_options')) {
    wp_die(esc_html__('You do not have sufficient capabilities to access this page.', 'import-markdown'));
}
...
<div class="wrap">
    ...
    <h2>Import Markdown - <?php esc_html_e('Options', 'import-markdown'); ?></h2>
            ...
            <div class="options-table-container">
                ...
                <div class="nav-tab-wrapper">
                    <a href="?page=daimma-options&tab=general_options"
                       class="nav-tab nav-tab-active"><?php esc_html_e('General', 'import-markdown'); ?></a>
                </div>
